...
//cette classe va récupérer tous les settings liés à la BDD et les stocker dans une propriété
class Mysql 
{
    private $db_name;
    private $db_user;
    ...
    //singlestone -> class qui n'aura qu'une seule instance peut importe le nombre de fois qu'elle est appelée
